...
import com.example.to_do_application.TaskActivity;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public class TaskViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTask(Task task) {
            ...
            if(task.getStatus() == com.example.to_do_application.Models.Task.STATUS_COMPLETED) {
                completeButton.setVisibility(View.GONE);
                startButton.setVisibility(View.GONE);
                delete.setVisibility(View.VISIBLE);
            }
            else if(task.getStatus() == com.example.to_do_application.Models.Task.STATUS_IN_PROGRESS){
            ...
            completeButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        cont.updateNoTaskBannerVisibility();
                        startButton.setVisibility(View.VISIBLE);
                        completeButton.setVisibility(View.GONE);
                    }
